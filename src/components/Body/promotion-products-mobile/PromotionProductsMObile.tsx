...
function PromotionProductsMobile() {
  ...
  return (
    <div className="mb-[51px] desktop:hidden">
              ...
              <div key={product.id} className="w-[170px]">
                <div className="w-[170px] h-[180px] rounded-[3px] bg-[#EBEFF3] flex justify-center items-center relative">
                  <img
                    ...
                    alt="Like"
                  />
                  <div className="absolute w-[60px] h-[23px] rounded-[5px] bg-[#FFFFFF] flex justify-center items-center left-[7px] top-[8px]">
                    <p className="font-Roboto font-[600] text-[11px] text-[#E81504]">
                      Aksiyada
                    </p>
                  </div>
                  <img
...
export default PromotionProductsMobile;

...
function PromotionProducts() {
  ...
  return (
    <div className="hidden desktop:block mb-[100px]">
              ...
              <div key={product.id} className="w-[273px]">
                <div className="w-[273px] h-[280px] rounded-[8px] bg-[#EBEFF3] flex justify-center items-center relative">
                  <img
                    ...
                    alt="Like"
                  />
                  <div className="absolute w-[78px] h-[30px] rounded-[5px] bg-[#FFFFFF] flex justify-center items-center left-[25px] top-[21px]">
                    <p className="font-Roboto font-[600] text-[14px] text-[#E81504]">
                      Aksiyada
                    </p>
                  </div>
                  <img
